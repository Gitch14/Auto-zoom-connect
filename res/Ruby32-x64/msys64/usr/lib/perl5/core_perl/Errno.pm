...
"x86_64-msys-thread-multi-3.3.6-341.x86_64" or
	die "Errno architecture (x86_64-msys-thread-multi-3.3.6-341.x86_64) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
